...
export default function GlobalError({
  ...
  return (
    <html lang="fr">
      <body className="min-h-screen bg-[#F5F7F5] text-[#17231D] antialiased">
        <main className="flex min-h-screen items-center justify-center px-5 py-12 sm:px-6">
          <div className="w-full max-w-[520px]">
            ...
            <section className="rounded-[20px] border border-[#E1E6E2] bg-white px-6 py-10 text-center shadow-[0_20px_60px_rgba(23,35,29,0.07)] sm:px-10">
              ...
              <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                <button
                  ...
                  className="inline-flex h-[48px] items-center justify-center rounded-xl bg-[#17231D] px-6 text-[13px] font-medium text-white transition hover:bg-[#293B31] focus:outline-none focus:ring-4 focus:ring-[#17231D]/15"
                >
                  Réessayer
                </button>
                ...
                <Link
                  href="/"
                  className="inline-flex h-[48px] items-center justify-center rounded-xl border border-[#D5DDD7] bg-white px-6 text-[13px] font-medium text-[#334139] transition hover:border-[#BFCAC2] hover:bg-[#F8FAF8] focus:outline-none focus:ring-4 focus:ring-[#65796C]/10"
                >
                  Retour à l&apos;accueil
                </Link>
              </div>
              ...
              <div className="mt-8 border-t border-[#ECEFEC] pt-6">
                ...
                <a
                  ...
                  className="mt-1 inline-block text-[12px] font-medium text-[#536B5C] hover:text-[#17231D] hover:underline"
                >
                  Contacter Fiduvia
                </a>
              </div>
            ...
            <p className="mt-7 text-center text-[11px] leading-5 text-[#8A938D]">
              © {new Date().getFullYear()} Fiduvia · Votre fiduciaire,
