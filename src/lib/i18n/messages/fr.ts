...
export const fr = {
  ...
  portal: {
    ...
    nav: {
      ...
      simulation: "Simulation d'impôt",
      instalments: "Détermination acomptes",
      review: "Relecture de déclaration",
  ...
  declaration: {
    ...
    immeubles: {
      ...
      dateConstruction: "Date de construction ou rénovation",
  ...
  simulationForm: {
    ...
    expressPill: "+ CHF 50",
    immeubleEntry: "Lieu de situation",
    lieuLabel: "Lieu de situation",
    acqLabel: "Date d'acquisition si en cours d'année",
    alienLabel: "Date d'aliénation si en cours d'année (Vente, donation, etc...)",
    loueLabel: "Cet immeuble est-il loué ?",
    detteLabel: "Existe-t-il une dette liée à l'immeuble ?",
    addImmeuble: "+ Ajouter un immeuble",
  ...
  documents: {
    ...
    categories: {
      ...
      autre: "Autre",
      formulaireAcomptes: "Formulaire de détermination des acomptes",
      copieDeclaration: "Copie de votre déclaration d'impôt",
  ...
  admin: {
    ...
    hub: {
      ...
      distributeError: "La distribution a échoué.",
      distribTitle1: "Distribuer les dossiers",
      distribSub1: "Sélectionnez les administrateurs concernés.",
      distribTitle2: "Nombre de dossiers à distribuer",
      distribSub2:
        "Choisissez le nombre par prestation, dans la limite des dossiers libres.",
      distribAvail: "libres",
      distribAvail1: "libre",
      distribNextBtn: "Continuer",
      distribBackBtn: "Retour",
      distribApplyBtn: "Distribuer",
      distribCancelBtn: "Annuler",
      distribDoneToast: "{n} dossier(s) distribué(s).",
      distribNothing: "Aucun dossier sélectionné.",
      distribNoAdmins: "Aucun administrateur disponible.",
    },
    detail: {
      statusLabel: "Statut du dossier",
      close: "Clôturer le dossier",
      closing: "Clôture…",
      closeConfirmTitle: "Êtes-vous vraiment sûr de clôturer le dossier ?",
      closeConfirmBody:
        "Le client sera notifié par e-mail du changement de statut.",
      closeYes: "Oui",
      closeNo: "Non",
      periodLabel: "Période fiscale",
      paymentTitle: "Statut de paiement",
      paid: "Payé",
      pending: "En attente",
      noPayment: "Aucun paiement",
      extraPayment: "Demande de paiement supplémentaire",
      docsReceived: "Documents reçus",
      priceTitle: "Tarif calculé",
      paymentStatusLabel: "Statut de paiement",
      markReceived: "Marquer les pièces reçues",
      marking: "Enregistrement...",
      downloadForm: "Télécharger le formulaire (PDF)",
      downloadDocs: "Télécharger les pièces (PDF)",
      downloadPreparing: "Préparation…",
      downloadFailed: "Le téléchargement a échoué.",
      downloadNoDocs: "Aucune pièce n'a encore été déposée.",
      formPdf: {
        title: "Déclaration d'impôts",
        firmName: "Fiduvia",
        ...
        page: "Page",
        of: "sur",
        generated: "Document généré le {date}",
      ...
      upload: "Téléverser",
      uploading: "Envoi…",
      commentsTitle: "Commentaires internes (équipe)",
      commentsEmpty: "Aucun commentaire pour l'instant.",
      commentPlaceholder: "Ajouter un commentaire…",
      commentAdd: "Ajouter",
      commentDelete: "Supprimer",
      errAction: "L'action n'a pas pu être effectuée.",
    },
    notify: {
      button: "Demande de pièce",
      title: "Demander des pièces",
      sub: "Sélectionnez les documents à demander. Un e-mail sera envoyé au client.",
      presetTitle: "Documents pré-enregistrés",
      addTitle: "Ajouter un document",
      addPlaceholder: "Ex. : Attestation de dons…",
      add: "Ajouter",
      removeExtra: "Retirer ce document",
      messageLabel: "Commentaire (facultatif)",
      messagePlaceholder: "Ex. : Merci de transmettre ces documents d'ici la fin du mois.",
      send: "Envoyer la demande par e-mail",
      errNoneSelected: "Sélectionnez au moins un document.",
    ...
    users: {
      ...
      sub: "Liste des comptes clients. Supprimez un compte à la demande de l'utilisateur.",
      ...
      deleting: "…",
      confirmDelete:
        "Supprimer ce compte client ? L'accès de la personne sera révoqué.",
      errPromote: "La promotion n'a pas pu être effectuée.",
      errDelete: "La suppression n'a pas pu être effectuée.",
    },
    stats: {
      title: "Statistiques",
      sub: "Activité et revenus de l'ensemble des dossiers pour la période sélectionnée.",
      ...
      perAdminFile: "dossier",
      perAdminView: "Voir les statistiques",
      perAdminFreeLabel: "Dossiers libres",
      perAdminFreeSub: "non attribués",
    },
    ...
    kpiReserved: "DOSSIERS RÉSERVÉS",
    kpiReservedSub: "toutes prestations confondues",
    kpiCompleted: "DOSSIERS TRAITÉS",
    kpiCompletedSub: "clôturés cette période",
    kpiRevenue: "CHIFFRE D'AFFAIRES PERSONNEL",
    kpiRevenueSub: "encaissé cette période",
